...
# metadata, and so on.
pkg_name=passenger
pkg_description="Passenger built with ruby 2.1.5"
...
pkg_version="5.1.2+ruby2.1.5"
# Overriding this because I am including the ruby version in this package version
